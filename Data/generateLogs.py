...
parser.add_argument("--output", "-o", dest='output_type', help="Write to a Log file, a gzip file or to STDOUT", choices=['LOG','GZ','CONSOLE','STDOUT'] )
...
outFileName = 'access-logs/access_log_'+timestr+'.log' if not file_prefix else 'access-logs/'+file_prefix+'_access_log_'+timestr+'.log'
